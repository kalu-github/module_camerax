...
class VideoFragment : BaseFragment<LibCameraxFragmentVideoBinding>(R.layout.lib_camerax_fragment_video) {
    companion object {
    ...
    private var flashMode by Delegates.observable(ImageCapture.FLASH_MODE_OFF) { _, _, new ->
        binding.btnFlash.setImageResource(
            when (new) {
                ImageCapture.FLASH_MODE_ON -> R.drawable.lib_camerax_ic_flash_on
                ImageCapture.FLASH_MODE_AUTO -> R.drawable.lib_camerax_ic_flash_auto
    ...
    override val binding: LibCameraxFragmentVideoBinding by lazy { LibCameraxFragmentVideoBinding.inflate(layoutInflater) }
    ...
    private fun toggleFlash() = binding.btnFlash.toggleButton(
        ...
        rotationAngle = 360f,
        firstIcon = R.drawable.lib_camerax_ic_flash_off,
        secondIcon = R.drawable.lib_camerax_ic_flash_on
    ) { flag ->
        isTorchOn = flag
